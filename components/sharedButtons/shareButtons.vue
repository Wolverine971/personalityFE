  ...
  computed: {
    ...
    gmailOptions () {
      return {
        ...
        cc: '',
        bcc: 'usersup@9takes.com',
        //   body: `<!DOCTYPE html>
        //         <html>
        //         <body style="background-color: #e9ecef;">
        //         <h1>The question:\n${this.question}?</h1>
        //           <a href="${this.url}">${this.question}?</a>
        //         </body>
        //         </html>
        // `,
        body: `The question:\n${this.question}?\n \n
